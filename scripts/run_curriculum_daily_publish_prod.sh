...
# A-Z는 블로그 발행 성공을 먼저 확정한다. 영상/TTS/네이버 클립은 본문 인라인 삽입이 아니라 발행 후 후처리로 돌린다.
export LONGTAIL_BLOG_INLINE_VIDEO="${LONGTAIL_BLOG_INLINE_VIDEO:-0}"
...
export LONGTAIL_VIDEO_TIMEOUT_SEC="${LONGTAIL_VIDEO_TIMEOUT_SEC:-1200}"
export LONGTAIL_VIDEO_TTS_TARGET_SEC="${LONGTAIL_VIDEO_TTS_TARGET_SEC:-89}"
export VIDEO_LONGTAIL_TARGET_SEC="${VIDEO_LONGTAIL_TARGET_SEC:-89}"
export VIDEO_TTS_MAX_SEC="${VIDEO_TTS_MAX_SEC:-89}"
export VIDEO_TTS_ALIGNMENT_MODE="${VIDEO_TTS_ALIGNMENT_MODE:-audio_driven}"
export VIDEO_TTS_SILENCE_BETWEEN_SEGMENTS_MS="${VIDEO_TTS_SILENCE_BETWEEN_SEGMENTS_MS:-0}"
export VIDEO_TTS_PROFILE="${VIDEO_TTS_PROFILE:-qwen_my_voice_legacy}"
export VIDEO_TTS_REF_AUDIO="${VIDEO_TTS_REF_AUDIO:-/home/kj/.local/share/kj-voice/qwen_approved_voice_20260509.wav}"
export VIDEO_TTS_REF_TEXT="${VIDEO_TTS_REF_TEXT:-AI 워크플로우와 자동화 시스템을 빠르게 짚어보겠습니다.}"
export VIDEO_TTS_SPEED="${VIDEO_TTS_SPEED:-1.07}"
export VIDEO_TTS_X_VECTOR_ONLY_MODE="${VIDEO_TTS_X_VECTOR_ONLY_MODE:-1}"
export VIDEO_TTS_LEGACY_VOICE_CLONE_PAYLOAD="${VIDEO_TTS_LEGACY_VOICE_CLONE_PAYLOAD:-1}"
export VIDEO_TTS_AUDIO_POSTPROCESS="${VIDEO_TTS_AUDIO_POSTPROCESS:-1}"
export VIDEO_TTS_SILENCE_THRESHOLD_DB="${VIDEO_TTS_SILENCE_THRESHOLD_DB:--45}"
export VIDEO_TTS_START_DURATION_SEC="${VIDEO_TTS_START_DURATION_SEC:-0.08}"
export VIDEO_TTS_START_SILENCE_SEC="${VIDEO_TTS_START_SILENCE_SEC:-0.04}"
export VIDEO_TTS_STOP_DURATION_SEC="${VIDEO_TTS_STOP_DURATION_SEC:-0.32}"
export VIDEO_TTS_STOP_SILENCE_SEC="${VIDEO_TTS_STOP_SILENCE_SEC:-0.25}"
export VIDEO_TTS_SILENCE_DETECTION="${VIDEO_TTS_SILENCE_DETECTION:-rms}"
export VIDEO_TTS_PITCH_FACTOR="${VIDEO_TTS_PITCH_FACTOR:-1.015}"
export VIDEO_TTS_TEMPO_FACTOR="${VIDEO_TTS_TEMPO_FACTOR:-1.005}"
