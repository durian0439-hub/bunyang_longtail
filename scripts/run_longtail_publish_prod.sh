...
# 2026-04-27 운영 중단: TTS 대본/썸네일 검수 전까지 롱테일(청약/경매/세금/대출) 영상 생성·업로드 금지
export LONGTAIL_VIDEO_UPLOAD="${LONGTAIL_VIDEO_UPLOAD:-0}"
export LONGTAIL_BLOG_INLINE_VIDEO="${LONGTAIL_BLOG_INLINE_VIDEO:-0}"
export LONGTAIL_VIDEO_TTS_ENABLED="${LONGTAIL_VIDEO_TTS_ENABLED:-0}"
export LONGTAIL_NAVER_CLIP_UPLOAD="${LONGTAIL_NAVER_CLIP_UPLOAD:-0}"
export LONGTAIL_NAVER_CLIP_VISIBILITY="${LONGTAIL_NAVER_CLIP_VISIBILITY:-private}"
