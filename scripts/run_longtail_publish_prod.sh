...
export LONGTAIL_TAX_NAVER_CATEGORY_NO="${LONGTAIL_TAX_NAVER_CATEGORY_NO:-14}"
...
export NAVER_BLOG_GPT_IMAGE_MAX_ASSETS="${NAVER_BLOG_GPT_IMAGE_MAX_ASSETS:-6}"
...
DOMAIN_CONFIGS = [
    ...
    },
    {
        'domain': 'tax',
        'label': '세금 롱테일',
        'category_no': os.environ.get('LONGTAIL_TAX_NAVER_CATEGORY_NO', '14').strip(),
