...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_bundle_parser.add_argument("--executor", choices=["playwright", "openai_compat", "mock", "none"], default="playwright")
    ...
    run_bundle_parser.add_argument("--text-route", default="gpt_web_playwright")
    run_bundle_parser.add_argument("--text-profile", default="gpt_text_profile_dev")
    run_bundle_parser.add_argument("--text-model-label", default="gpt-web-text")
    ...
    queue_text_parser.add_argument("--route", default="gpt_web_playwright")
    queue_text_parser.add_argument("--profile", default="gpt_text_profile_dev")
    queue_text_parser.add_argument("--model-label", default="gpt-web-text")
